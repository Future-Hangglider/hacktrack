...
def framestotime(videoledonvalues, ledswitchtimes):
    ...
    print("Framerate", 1/k.slope, "rvalue", rvalue, "overlap", s[2])
    ...
    if markerIds is not None:
        ...
        if retval is not None:
            ...
            if retval:
                ...
                cv2.aruco.drawAxis(frameUndistorted, cameraMatrix, None, rvec, tvec, 0.1) # should be newcameraMatrix, but doesn't work
